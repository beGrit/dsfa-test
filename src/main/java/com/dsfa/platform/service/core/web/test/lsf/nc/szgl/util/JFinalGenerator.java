package com.dsfa.platform.service.core.web.test.lsf.nc.szgl.util;
...
public class JFinalGenerator {
    public static void main(String[] args) {
        ...
        String modelPackageName = "com.dsfa.platform.service.core.web.test.lsf.nc.szgl.model";
        ...
        MetaBuilder metaBuilder = new MetaBuilder(dataSource)
                ...
                .skip(tableName -> {
                    return !tableName.startsWith("test_lsf_nc_szgl");
                });
