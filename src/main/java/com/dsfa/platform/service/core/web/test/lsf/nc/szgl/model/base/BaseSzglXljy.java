...
public abstract class BaseSzglXljy<M extends BaseSzglXljy<M>> extends DsfaBaseModel<M> implements IBean {

	public M setTestLsfNcSzglXljyId(java.lang.String testLsfNcSzglXljyId) {
		set("test_lsf_nc_szgl_xljy_id", testLsfNcSzglXljyId);
		return (M)this;
	}
	
	public java.lang.String getTestLsfNcSzglXljyId() {
		return getStr("test_lsf_nc_szgl_xljy_id");
	}
