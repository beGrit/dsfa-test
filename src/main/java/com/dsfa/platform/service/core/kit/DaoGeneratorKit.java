package com.dsfa.platform.service.core.kit;
...
/**
 * @ClassName DaoGeneratorKit
 * @Description TODO
 * @Author pocky
 * @Date 2021/7/21
 **/
public class DaoGeneratorKit {
    public static void main(String[] args) {
        ...
        MetaBuilder metaBuilder = new MetaBuilder(dataSource)
                ...
                .skip(tableName -> {
                    return !tableName.startsWith("test_lsf_nc");
                });
        ...
        // 设置去除前缀
        gen.setRemovedTableNamePrefixes("test_lsf_nc");
